        ...
        <main className="w-full min-h-screen py-10 px-4 mb-10">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="mb-10 pb-6 border-b border-gray-200">
                    <select value={filter} onChange={(e) => setFilter(e.target.value)} className="bg-gray-50 border border-gray-200 text-gray-700 text-sm rounded-lg p-3 outline-none" style={{ width: "200px" }}>
                ...
                <div className="flex flex-col gap-6">
                    {filteredData.length === 0 ? (
                        ...
                        filteredData.map((item, index) => (
                            <div key={index} className="flex items-center gap-4 p-4 bg-white border border-gray-100 shadow-sm rounded-2xl hover:border-gray-200 transition">
                                ...
                                <button onClick={() => handleDelete(index)} className="p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all">
                                    <FaTrash size={16} />
                                </button>
                            </div>
                        ))
