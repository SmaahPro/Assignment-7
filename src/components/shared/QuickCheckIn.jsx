    ...
    return (
        <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100 mb-5 w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <button onClick={() => handleCheckIn('Call')} className="bg-gray-50 border border-gray-200 p-6 rounded-2xl flex flex-col items-center justify-center gap-3 hover:bg-gray-100 transition w-full">
                    <FaPhone className="text-2xl text-[#1e463a]" />
                    <span className="text-sm font-semibold">Call</span>
                </button>
                <button onClick={() => handleCheckIn('Text')} className="bg-gray-50 border border-gray-200 p-6 rounded-2xl flex flex-col items-center justify-center gap-3 hover:bg-gray-100 transition w-full">
                    <FaComment className="text-2xl text-[#1e463a]" />
                    <span className="text-sm font-semibold">Text</span>
                </button>
                <button onClick={() => handleCheckIn('Video')} className="bg-gray-50 border border-gray-200 p-6 rounded-2xl flex flex-col items-center justify-center gap-3 hover:bg-gray-100 transition w-full">
